    ...
    <div className='p-3 max-w-7xl mx-auto' id='about'>
      <div className='px-6 mt-5 max-w-7xl '>
        ...
        <div className='p-3 mt-10 flex flex-wrap gap-5'>
          {projects.map(({ title, description, techs, github, live }) => (
            <div
              key={title}
              className='rounded-lg transform hover:-translate-y-0.5 bg-white p-3 shadow-xl  mx-auto  duration-75 ease-in-out hover:shadow-2xl  hover:dark:shadow-sky-500 lg:w-96'
            >
              <h3 className='text-3xl font-bold text-sky-600'>{title}</h3>
