        ...
        <div className='p-3 mt-10 flex flex-wrap gap-5'>
          {projects.map(
            ({ title, description, techs, github, live, image }) => (
              <div
                key={title}
                className='rounded-lg transform hover:-translate-y-0.5 bg-white p-3 shadow-xl mx-auto duration-75 ease-in-out hover:shadow-2xl hover:dark:shadow-sky-500 w-80 lg:w-96'
              >
                <img
                  src={image}
                  alt='thumbnail'
